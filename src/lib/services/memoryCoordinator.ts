...
export interface MemoryEvent {
	...
	story_id: number;
	timestamp: Date;
	event_type: 'action' | 'dialogue' | 'discovery' | 'relationship_change' | 'story_progression' | 'combat' | 'other';
	title: string;
	description: string;
...
export interface MemoryConflict {
	conflict_type: 'temporal_inconsistency' | 'character_contradiction' | 'plot_hole' | 'factual_error';
	severity: 'low' | 'medium' | 'high' | 'critical';
	description: string;
