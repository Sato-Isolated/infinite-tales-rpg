<script lang="ts">
	...
	import GameModals from '../modals/GameModals.svelte';
	import StorySection from '../story/StorySection.svelte';
	import ActionButtons from '../actions/ActionButtons.svelte';
	import ActionInputForm from '../actions/ActionInputForm.svelte';
	import StaticActionsPanel from '../actions/StaticActionsPanel.svelte';
	import TimeWidget from '../time/TimeWidget.svelte';
