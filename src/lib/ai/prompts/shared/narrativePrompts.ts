...
export const storyWordLimitDetailed = 'should be between 400 and 600 words (approximately 2700-4000 characters). Write rich, detailed narrative with vivid descriptions, character emotions, environmental details, and immersive dialogue. Include sensory details, character thoughts and motivations, atmospheric elements, and comprehensive scene-setting. The narrative should be engaging and cinematic in scope.';
