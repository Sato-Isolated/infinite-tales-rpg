import type { GameActionState, PlayerCharactersGameState, PlayerCharactersIdToNamesMap } from '$lib/ai/agents/gameAgent';
...
export function getEmptyResourceKeysForGameEnd(
  ...
  return gameLogic.getEmptyCriticalResourceKeys(
    playerCharactersGameState[playerCharacterId]
  );
}
 ...
 */
export function getLatestStoryMessages(
  historyMessages: any[],
  numOfActions: number = 2
): any[] {
